...
//$globals['url_shortener'] = 'ir.gl';
//$globals['url_shortener_to'] = 'chuza.gl';
//$globals['url_shortener_mobile_to'] = 'm.chuza.gl'; // Automatic redirection to mobile version
...
$globals['base_sneakme_url'] = 'chios/';
...
$globals['time_enabled_votes'] = 86400 * 7; // 7 days - Modificado 26/09/10
$globals['time_enabled_negative_votes'] = 7200; // 2 hour
...
$globals['js_main'] = 'general05.js.php';
// CSS files (main, color, notame)
$globals['css_main'] = 'css/es/mnm67.css';
...
$globals['standards'] = Array(
    1 => Array( 'id'=>1, 'name'=>_("galego RAG"), 'short_name'=>'gl_ES.utf8'),
    2 => Array( 'id'=>2, 'name'=>_("português"), 'short_name'=>'es_ES.utf8')
);

$globals['show_blog'] = true;
$globals['show_wiki'] = true;

$globals['do_reduggy'] = false;

//$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >Hoxe celebramos a I Asemblea Xeral Extraordinaria / Assembleia Geral Extraordinária</a>';
//$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >A nosa nova política / Notre nouvelle politique</a>';
//$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >Novidades na web: Agora com Metacategorias</a>';
//$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >Novidades na web: Karma e comentarios aniñados</a>';
//$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >I Assembleia Geral Ordinária / Asemblea Xeral Ordinaria</a>';
//$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >IMPORTANTE: APRAZADA a I Assembleia Geral Ordinária / Asemblea Xeral Ordinaria</a>';
//$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >Convocada a I Assembleia Geral Ordinária / Asemblea Xeral Ordinaria Virtual</a>';
//$globals['news'] = '<a href="/story/i-assembleia-geral-ordinaria-asemblea-xeral-ordinaria-chuza" style="color:white;font-weight:bold;" >Está-se a celebrar a I Assembleia Geral Ordinária / Asemblea Xeral Ordinaria Virtual</a>';
//$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >RadioChuza: colabora no novo proxecto da Asociación</a>';
//$globals['news'] = '<a href="/search.php?q=diaz+pardo" style="color:white;font-weight:bold;" >Isaac Diaz Pardo (1920-2012)</a>';
//$globals['news'] = '<a href="http://pt.wikipedia.org/wiki/Stop_Online_Piracy_Act" style="color:white;font-weight:bold;" >Stop SOPA</a>';
//$globals['news'] .= ' <a href="http://belay.es/2012/01/non-quero-mais-sopa/" style="color:red;font-weight:bold;padding-left:40px;" >Que é a SOPA?</a>';
//$globals['news'] .= ' <a href="http://chuza.gl/blog/?p=68" style="color:white;font-weight:bold;padding-left:40px;" >Chuzarrascada e encontro de Desenvolvedores / Datos de 2011</a>';
//$globals['news'] .= ' <a href="http://chuza.gl/wiki/index.php/Chuzarrascada_04/03/2012" 
//style="color:white;font-weight:bold;padding-left:40px;" >Ap&uacute;ntate aqu&iacute; &aacute; Chuzarrascada do 4 de 
//Marzo</a>';
//$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >1 de Abril</a>';
$globals['news'] = '<a href="/blog" style="color:white;font-weight:bold;" >Letras Galegas 2012 - Mudanzas na web</a>';


$globals['chuzamail'] = true;

$globals['user_agent'] = 'Chuzabot (http://chuza.gl/)';
...
//$globals["1stApril"]=true;;

$globals["show_calendar"] = true;

$globals["association_users"] = Array(
  377, //parasito
  15, // Socram
  397, // leviatan
  5, // galeguzo
...
$globals['gCalendar_user'] = 'chuza.gl@gmail.com';
$globals['gCalendar_password'] = 'bertolameu2010';

$globals['show_gzradio'] = true;
$globals['show_bottom_sidebar_banner'] = false;
